...
const Card:React.FC<CardProps> = ({
    ...
    return(
        <div className="w-full hidden gap-2 sm:flex sm:flex-col h-full relative">
            <img src="/assets/posters/ferrari_ver3_xlg.jpg" className="rounded-2xl object-cover w-full" alt="" />
